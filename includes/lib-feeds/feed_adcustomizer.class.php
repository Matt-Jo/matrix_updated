...
class feed_adcustomizer extends data_feed {
	...
	public function __construct() {
		...
		$this->ftp_server = "ftp.netelixir.com";
		$this->ftp_user = "cablesandkits@netelixir.com";
		$this->ftp_pass = "netelixir@16";
		$this->ftp_path = "";
		$this->destination_filename = 'adcustomizer.txt';
	...
	private static function track_failure($products_id, $reason) {
		$insert = [':feed' => 'adcustomizer', ':products_id' => $products_id, ':reason' => $reason];
	...
	public function build() {
		...
		foreach ($products_ids as &$products_id) {
			...
			$link = 'www.cablesandkits.com'.$product->get_url().'?utm_source=google&utm_medium=cpc&utm_term='.$products_id.'&ne_ppc_id=2221&ne_kw='.$products_id;
