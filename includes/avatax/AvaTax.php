...
//function __autoload($class_name) - MMD since we are using ZF we cannot use this function for the autoloader
function avatax_autoload($class_name)
{ 	
...
spl_autoload_register('avatax_autoload');
