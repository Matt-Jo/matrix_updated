...
*/
		...
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_TITLE')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_TITLE', 'Domestic UPS');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_DESCRIPTION')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_DESCRIPTION', 'Domestic UPS');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_UNKNOWN_ERROR')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_UNKNOWN_ERROR', 'An unknown error occured with the ups shipping calculations.');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_IF_YOU_PREFER')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_IF_YOU_PREFER', 'If you prefer to use ups as your shipping method, please contact');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_ERROR')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_ERROR', 'A communication error occured while attempting to contact the UPS gateway');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_UNKNOWN_ERROR')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_UNKNOWN_ERROR', 'An unknown error occured while attempting to contact the UPS gateway');
		if (!defined('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_VERSION_ERROR')) define('MODULE_SHIPPING_UPSXML_RATES_TEXT_COMM_VERSION_ERROR', 'This module supports only xpci version 1.0001 of the UPS Rates Interface. Please contact the webmaster for additional assistance.');
