<h3>Top Grossing Under Stocked IPNs</h3>
<p>This report shows the top 50 gross margin products in the past 90 days that are currently understocked. Understocked is defined as having fewer days supply than MIN + .25 * (TGT - MIN).</p>
<?php
...
FROM products_stock_control psc
	...
	having (if(daily_quantity = 0, 999, ceil(ifnull(available_quantity, 0) / daily_quantity) )) < lower_supply_threshold
	ORDER BY gross_margin DESC LIMIT 50", cardinality::SET);

?>
<table id="tab1table" cellspacing="0" cellpadding="0" border="0" class="fc tablesorter">
	<thead>
		<tr>
