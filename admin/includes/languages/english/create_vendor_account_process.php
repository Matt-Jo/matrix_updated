...
if (!defined('EMAIL_PASS_1')) define('EMAIL_PASS_1', 'Your password for this account is ');
if (!defined('EMAIL_PASS_2')) define('EMAIL_PASS_2', ', keep it in a safe place. (Please note: Your password is case sensitive.)');
