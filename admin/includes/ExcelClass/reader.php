...
if (!defined('SPREADSHEET_EXCEL_READER_WORKBOOKGLOBALS')) define('SPREADSHEET_EXCEL_READER_WORKBOOKGLOBALS',	0x5);
if (!defined('SPREADSHEET_EXCEL_READER_WORKSHEET')) define('SPREADSHEET_EXCEL_READER_WORKSHEET',		0x10);

if (!defined('SPREADSHEET_EXCEL_READER_TYPE_BOF')) define('SPREADSHEET_EXCEL_READER_TYPE_BOF',		0x809);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_EOF')) define('SPREADSHEET_EXCEL_READER_TYPE_EOF',		0x0a);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_BOUNDSHEET')) define('SPREADSHEET_EXCEL_READER_TYPE_BOUNDSHEET',	0x85);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_DIMENSION')) define('SPREADSHEET_EXCEL_READER_TYPE_DIMENSION',	0x200);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_ROW')) define('SPREADSHEET_EXCEL_READER_TYPE_ROW',		0x208);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_DBCELL')) define('SPREADSHEET_EXCEL_READER_TYPE_DBCELL',		0xd7);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_FILEPASS')) define('SPREADSHEET_EXCEL_READER_TYPE_FILEPASS',	0x2f);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_NOTE')) define('SPREADSHEET_EXCEL_READER_TYPE_NOTE',		0x1c);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_TXO')) define('SPREADSHEET_EXCEL_READER_TYPE_TXO',		0x1b6);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_RK')) define('SPREADSHEET_EXCEL_READER_TYPE_RK',			0x7e);
define('SPREADSHEET_EXCEL_READER_TYPE_RK2',		0x27e);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_MULRK')) define('SPREADSHEET_EXCEL_READER_TYPE_MULRK',		0xbd);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_MULBLANK')) define('SPREADSHEET_EXCEL_READER_TYPE_MULBLANK',	0xbe);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_INDEX')) define('SPREADSHEET_EXCEL_READER_TYPE_INDEX',		0x20b);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_SST')) define('SPREADSHEET_EXCEL_READER_TYPE_SST',		0xfc);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_EXTSST')) define('SPREADSHEET_EXCEL_READER_TYPE_EXTSST',		0xff);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_CONTINUE')) define('SPREADSHEET_EXCEL_READER_TYPE_CONTINUE',	0x3c);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_LABEL')) define('SPREADSHEET_EXCEL_READER_TYPE_LABEL',		0x204);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_LABELSST')) define('SPREADSHEET_EXCEL_READER_TYPE_LABELSST',	0xfd);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_NUMBER')) define('SPREADSHEET_EXCEL_READER_TYPE_NUMBER',		0x203);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_NAME')) define('SPREADSHEET_EXCEL_READER_TYPE_NAME',		0x18);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_ARRAY')) define('SPREADSHEET_EXCEL_READER_TYPE_ARRAY',		0x221);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_STRING')) define('SPREADSHEET_EXCEL_READER_TYPE_STRING',		0x207);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_FORMULA')) define('SPREADSHEET_EXCEL_READER_TYPE_FORMULA',	0x406);
define('SPREADSHEET_EXCEL_READER_TYPE_FORMULA2',	0x6);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_FORMAT')) define('SPREADSHEET_EXCEL_READER_TYPE_FORMAT',		0x41e);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_XF')) define('SPREADSHEET_EXCEL_READER_TYPE_XF',			0xe0);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_BOOLERR')) define('SPREADSHEET_EXCEL_READER_TYPE_BOOLERR',	0x205);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_UNKNOWN')) define('SPREADSHEET_EXCEL_READER_TYPE_UNKNOWN',	0xffff);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_NINETEENFOUR')) define('SPREADSHEET_EXCEL_READER_TYPE_NINETEENFOUR', 0x22);
if (!defined('SPREADSHEET_EXCEL_READER_TYPE_MERGEDCELLS')) define('SPREADSHEET_EXCEL_READER_TYPE_MERGEDCELLS', 0xE5);

if (!defined('SPREADSHEET_EXCEL_READER_UTCOFFSETDAYS')) define('SPREADSHEET_EXCEL_READER_UTCOFFSETDAYS' ,	25569);
define('SPREADSHEET_EXCEL_READER_UTCOFFSETDAYS1904', 24107);
if (!defined('SPREADSHEET_EXCEL_READER_MSINADAY')) define('SPREADSHEET_EXCEL_READER_MSINADAY',		86400);
//define('SPREADSHEET_EXCEL_READER_MSINADAY', 24 * 60 * 60);

//define('SPREADSHEET_EXCEL_READER_DEF_NUM_FORMAT', "%.2f");
if (!defined('SPREADSHEET_EXCEL_READER_DEF_NUM_FORMAT')) define('SPREADSHEET_EXCEL_READER_DEF_NUM_FORMAT',	"%s");
...
//end of changes by mmp
	...
	function createDate($numValue) {
		...
		print "TEST: [$raw] [$numValue] [$string]<br/>";
